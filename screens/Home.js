...
import { COLORS, icons, SIZES, FONTS, images, dummyData, constants } from '../constants';
...
const TabIndicator = ({ measureLayout, scrollX}) => {
  ...
  //calculate the tabIndicator width
  ...
  /**
   * @param Animate the X position of the horizontal flatlist
   */
...
/* Next, animate the Tab positon so
that items rendered in each list is according
to the button clicked
*/

/**
 *
 * @param {* X position of the tab} param0
 * @param { * The width of the Tab } param1
 * @returns appTheme and scrollX
 */
const Tabs = ({ appTheme, scrollX, onPromoTabPress }) => {

  /**
   * @param use hook to store the major layout information
   */
  ...
  function renderAvailableRewards() {
    return (
      ...
      >
        ...
        <View style ={{
          flex: 1, backgroundColor: COLORS.lightPink,
          marginLeft: -10,
          borderRadius: 15,
          alignItems: 'center',
          justifyContent: 'center'
           ...
           return (
            <View style={{
              ...
              paddingTop: SIZES.padding
               ...
               {/**Description */}
               <Text style={{
                 marginLeft: 3, color: appTheme.textColor, ...FONTS.body4
